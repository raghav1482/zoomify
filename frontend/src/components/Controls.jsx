    ...
    <div className="controls-page">
      ...
      {screenTrack ? (
        ...
        >
          ...
          variant="contained"
          color={trackState.video ? "primary" : "secondary"}
          onClick={startScreenSharing}style={{backgroundColor:"grey"}}
        >
     ...
     : ''
      ...
      <button onClick={()=>{
        ...
        }} style={{backgroundColor:"white",color:"#006aff",borderRadius:"50%",width:"50px",height:"50px",display:"flex",justifyContent:"center",alignItems:"center"}}>
        ...
        }} style={{backgroundColor:"white",color:"#006aff",borderRadius:"50%",width:"50px",height:"50px",display:"flex",justifyContent:"center",alignItems:"center",marginBottom:"30px"}}>
